void main(){
    while(true){
        ...
        try {
            ...
            String tal1String = IO.readln();
            int tal1 = 0;
            try {
            tal1 = Integer.parseInt(tal1String);
            } catch (Exception e) {
                IO.println("Du har inmatat ett fel värde.");
            }

            IO.println("Ange det andra talet.");
            String tal2String = IO.readln();
            int tal2 = 0;
            try {
            tal2 = Integer.parseInt(tal2String);
            } catch (Exception e) {
                IO.println("Du har inmatat ett fel värde.");
            }
